...
import kz.store.cash.service.diary.DiaryCustomerApi;
...
public class DiaryCustomersDialogController implements CancellableDialog {
  ...
  private final DiaryCustomerApi api;
  ...
  private Node loadPage(int pageIndex) {
    ...
    fx.runWithLoader(root, "Загрузка клиентов...",
        () -> api.getPage(page, currentSearch, currentOrder),
        this::applyPage);
    return new Label(); // пустой placeholder
  }
